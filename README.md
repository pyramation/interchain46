...
```sh
npm install interchain46
```
## Table of contents

- [interchain46](#interchain46)
  - [Install](#install)
...
Import the `cosmos` object from `interchain46`. 
...
```js
import { getSigningcosmosClient } from 'interchain46';
...
Contract schemas live in `./contracts`, and protos in `./proto`. Look inside of `scripts/codegen.js` and configure the settings for bundling your SDK and contracts into `interchain46`:
